...
import { AntecedenteHeredofamiliares } from "../nutrition/patient/data";
import Input from "../../../../atoms/input/Input";
import { useNotification } from "../../../../../../context/NotificationContext";
import { useModal } from "../../../../../../context/ModalContext";

type UseTypeComponent = AntecedenteHeredofamiliares
...
const Heredofamiliares: FC<Props> = ({ data, id, patientId, reload }) => {

    const { close } = useModal();
    const notification = useNotification();
    const title = `Antecedentes Heredofamiliares`;
    const path = `heredofamiliares`;
